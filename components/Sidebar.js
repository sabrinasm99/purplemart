...
function Sidebar() {
  return (
    <React.Fragment>
      <div className="w-4/5 md:w-3/5 m-auto py-5 md:py-3 md:px-3 md:my-5 md:bg-gray-200 md:overflow-x-auto md:rounded-md">
          ...
          <div className="w-1/2 sm:w-1/3 md:w-1/4 flex-none p-1">
            <Link href='/grocery'>
              <div className="rounded-md shadow-xl md:shadow-md text-center bg-white p-2 h-full flex flex-col cursor-pointer">
                ...
                <span className="block pt-3 md:pt-0 mt-auto text-purple-800 tracking-wide text-sm md:text-xs md:font-medium">
                  GROCERY
                </span>
              </div>
            </Link>
